...
use ZnLib\Wsdl\Symfony\Web\Controllers\DefinitionController;
use Symfony\Component\Routing\Loader\Configurator\RoutingConfigurator;
use ZnLib\Wsdl\Symfony\Web\Controllers\TransportController;
...
return function (RoutingConfigurator $routes) {
    ...
    /*$routes
        ...
        ->controller([\ZnLib\Wsdl\Symfony\Web\Controllers\WsdlClientController::class, 'index'])
        ->methods(['POST', 'GET']);*/
};
